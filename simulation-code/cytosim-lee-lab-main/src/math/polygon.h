...
public:
    ...
    /// move all points by given scale
    ...
    /// Performs the determinant test
    real determinantTest(const Point2D &P0, const Point2D &P1, real x,
                         real y) const;

    int insideWinding(real x, real y) const;
